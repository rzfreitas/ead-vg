...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$ead_vg_description = get_bloginfo( 'description', 'display' );
			if ( $ead_vg_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $ead_vg_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
